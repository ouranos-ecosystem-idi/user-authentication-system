...
func (_m *IOperatorUsecase) GetOperators(getOperatorsInput traceability.GetOperatorsInput) (traceability.OperatorModels, error) {
	ret := _m.Called(getOperatorsInput)

	var r0 traceability.OperatorModels
	var r1 error
	if rf, ok := ret.Get(0).(func(traceability.GetOperatorsInput) (traceability.OperatorModels, error)); ok {
		return rf(getOperatorsInput)
	}
	if rf, ok := ret.Get(0).(func(traceability.GetOperatorsInput) traceability.OperatorModels); ok {
		r0 = rf(getOperatorsInput)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(traceability.OperatorModels)
		}
	}
...
type mockConstructorTestingTNewIOperatorUsecase interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewIOperatorUsecase(t mockConstructorTestingTNewIOperatorUsecase) *IOperatorUsecase {
